...
#### 1. Generating the dataset
  ...
  - Each particle was annotated using online labelling service by [Supervisely](https://supervise.ly/). Since the number of particles in each image varied from 190 to 620, which made labelling process time consuming, two-step augmentation procedure was performed thereafter over 9 images.
